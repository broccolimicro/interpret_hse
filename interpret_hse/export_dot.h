...
parse_dot::attribute_list export_attribute_list(const hse::iterator i, const hse::graph &g, const petri::CompositionAnalysis &comp, bool labels = false, bool ghost = false, int encodings = -1);
parse_dot::statement export_statement(const hse::iterator &i, const hse::graph &g, const petri::CompositionAnalysis &comp, bool labels = false, bool ghost = false, int encodings = -1);
