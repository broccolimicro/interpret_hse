...
boolean::cube import_boolean_assignment(const parse_cog::assignment &syntax, ucs::Netlist nets, tokenizer *tokens, int region = 0, bool auto_define = false);
...
hse::segment import_segment(hse::graph &dst, const parse_cog::composition &syntax, boolean::cover &covered, bool &hasRepeat, int default_id, tokenizer *tokens, bool auto_define);
